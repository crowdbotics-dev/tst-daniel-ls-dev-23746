...
## Project Structure
    ...
    ├── tst_daniel_ls_dev_23746  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_ls_dev_23746`
...
2. Clone this repo and `cd tst_daniel_ls_dev_23746`
